...
2.问道价格怎么回复" 
                    ...
                    <div class="footerBtn">
                        ...
                        <Button size="large" type="primary" :loading="isDisabled" icon="md-checkmark" @click="add_manuscript(1)">提交</Button>           
                    </div>
                </div>
            </Card>
            </Col>
...
<script>
    ...
    import { seedingAddMaterial, packageList, getSeedingMaterialDetail } from '@/libs/api';
