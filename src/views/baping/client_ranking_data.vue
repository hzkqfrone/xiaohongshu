    ...
    <div>
        <Card>
            ...
            <Form :label-width="$store.state.app.isFromMobile?auto:90" :label-position="$store.state.app.isFromMobile?'top':'right'" class="addContent" ref="params" inline>
                ...
                <FormItem label="是否重点词" v-if="!isAuth([2])">
                    <Select v-model="params.is_point" filterable clearable style="width:200px" @on-change="serchData">
                ...
                <!-- <FormItem label="显示全部" v-if="!isAuth([2])">
                    <i-switch :true-value="1" :false-value="0" v-model="params.all" @on-change="serchData" />
                </!--> 
            </Form>
        ...
        <Card style="margin-top:20px">
            <div class="button_wrap">
                <Button type="primary" icon="md-add" @click="addParams={is_point:0};keyword='';addKeywordModal=true;"  v-if="isAuth([1, 5, 6])">添加关键词</Button>
            </div>
        ...
        <Modal
            ...
            <Form label-position="top">
                ...
                <FormItem label="重点词：">
                    <Checkbox label="twitter" :true-value="1" :false-value="0" v-model="addParams.is_point">勾选为重点词</Checkbox>
                </FormItem>
                <FormItem label="关键词：">
...
<script>
    import { addScreenKeyword, getScreenKeywordList, delScreenKeyword, screenCutomerList } from '@/libs/api';
