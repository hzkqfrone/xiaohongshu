    ...
    <div>
        ...
        <Modal
            ...
            <Form label-position="top">
                <FormItem label="标题">
                    <Input v-model="docParams.title" placeholder="标题"/>
                </FormItem>
                <FormItem label="内容">
                    ...
                    <editor :details="docParams.content" id="editor1" ref="textarea"></editor>
                </FormItem>
            </Form>
            <div slot="footer">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //保存
            submitSaveBtn(){
                this.docParams.material_type = 0;         //0素材
                this.docParams.content = this.$refs.textarea.$refs.ueditor.editor.body.innerHTML;
                uploadMaterial(this.docParams).then(res => {
                    if(res.code == 200){
                        this.$Notice.success({title: res.message});
